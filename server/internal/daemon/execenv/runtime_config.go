...
// For CodeBuddy:  writes {workDir}/AGENTS.md  (CodeBuddy Code reads AGENTS.md natively)
...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "openclaw", "hermes", "pi", "cursor", "kimi", "kiro", "antigravity", "codebuddy":
